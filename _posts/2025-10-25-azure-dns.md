...
¿No sabes qué es DNS? El DNS es como la guía telefónica de Internet: traduce nombres fáciles de recordar (como google.com) en direcciones que entienden los ordenadores.

En la nube de Microsoft (Azure), puedes gestionar tus propios nombres y direcciones usando Azure DNS. Así controlas cómo se conectan tus aplicaciones y servicios.

En este artículo, te explico cómo hacerlo paso a paso usando **Terraform**, una herramienta que te permite crear y modificar todo con archivos de texto, aunque nunca lo hayas hecho antes.
